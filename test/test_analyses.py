...
from opengrid.library import exceptions
...
class AnalysisTest(unittest.TestCase):
    ...
    def test_standby(self):
        ...
        self.assertRaises(exceptions.EmptyDataFrame, analysis.standby, pd.DataFrame)
    ...
    def test_share_of_standby_1(self):
        ...
        share_of_standby = analysis.share_of_standby(df, resolution='24h')
